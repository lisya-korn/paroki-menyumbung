  ...
  return (
    <div className="container" style={{ padding: '40px 20px', maxWidth: '800px' }}>
      <div style={{ marginBottom: '32px' }}>
        <h1 style={{ color: 'var(--color-primary)' }}>Buat Pengumuman Baru</h1>
        <p style={{ color: 'var(--color-text-light)' }}>Isi detail informasi yang ingin Anda publikasikan kepada umat.</p>
      </div>

      <div style={{ background: 'white', padding: '32px', borderRadius: '12px', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)' }}>
        <form action={createAnnouncement} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div style={{ flex: 1 }}>
              ...
              <input 
                ...
                type="text" 
                required
                placeholder="Contoh: Jadwal Misa Pekan Suci 2025"
                style={{ width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid #E5E7EB', outline: 'none' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: '8px', fontWeight: 500 }}>Tanggal (Opsional)</label>
              <input 
                name="createdAt"
                type="date"
