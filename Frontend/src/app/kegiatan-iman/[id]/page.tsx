            ...
            <div className="sidebar-card">
              ...
              <div className="sidebar-list">
                {beritaLainnya.map((item: any) => (
                  <Link href={`/kegiatan-iman/${item.id}`} key={item.id} className="sidebar-item">
                ...
                {beritaLainnya.length === 0 && <p style={{ fontSize: '0.9rem', color: '#6B7280' }}>Belum ada kegiatan lain.</p>}
              </div>
            </div>
          </aside>
        </div>
