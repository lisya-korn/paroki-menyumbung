  ...
  return (
    <>
      <section className="page-header">
        ...
        <h1 className="page-header__title">Berita Paroki</h1>
        <p className="page-header__desc">
          Kumpulan berita umum, informasi paroki, dan kabar terkini dari Desa Menyumbung
        </p>
      </section>
                ...
                <Link href={`/berita/${item.id}`} key={item.id}>
                  <article className="card">
                    <div className="card__image-wrapper">
                      ...
                      <span className="card__badge">{item.badge || 'Berita'}</span>
                    </div>
